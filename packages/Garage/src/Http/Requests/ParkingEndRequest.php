...
class ParkingEndRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "SessionId" => ["bail", "required", "uuid", "string"],
            ...
            "EquipmentNumber" => ["bail", "nullable", "numeric"],

            "EntryDate" => ["bail", "required", "string", "date"],

            "TicketId" => ["bail", "nullable", "string"],

            "ExitDate" => ["bail", "required", "string", "date"],

            "Amount" => ["bail", "nullable", "numeric"],

            "ClosingType" => ["bail", "nullable", "string"],
        ];
    }
}
