...
class ParkingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'start_confirmed_at' => $this->formatDateTime($this->start_confirmed_at),
            ...
            'files' => ParkingFileResource::collection($this->parkingFiles),
        ];
    }

    protected function formatDateTime($date)
    {
        return $date ? Carbon::parse($date)->setTimezone('Asia/Riyadh')->toDateTimeString() : null;
    }
}
